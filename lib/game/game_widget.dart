...
class GameWidget<G extends Game> extends StatefulWidget {
  ...
  ///
  /// For how to use it see [GameWidget.withOverlay]
...
class _GameWidgetState extends State<GameWidget> {
  ...
  void onChangeActiveOverlays() {
    final game = widget.game as HasWidgetsOverlay;
    game.overlays.value.forEach((overlayKey) {
      assert(widget.overlayBuilderMap.containsKey(overlayKey),
          "A non mapped overlay has been added: $overlayKey");
    });
    setState(() {
      activeOverlays = game.overlays.value;
    });
  }
