...
class RedWarrior extends SpriteAnimationComponent {
  ...
  double topBound;
  double bottomBound;
  final Vector2 startPosition = Vector2(-20,85);
  ...
  @override
  Vector2 position = Vector2(-20,85);
  @override
  ...
  double speed = 0.02;
  RedWarrior(SpriteSheet warriorSheet, SpriteAnimation animation, BoundingBox boundingBox) : super(Vector2(190,180),  animation) {
  ...
  void update(double t) {
    ...
    hitBox = toRect().deflate(deflation);
    ticker+=1;
    if(ticker>1000){ticker = 0;print("interval");}//avoid overflow
  ...
  bool collision() {
    ...
    if(enemyBox == null){return false;} print(lockPosition);print(animation.onComplete);
