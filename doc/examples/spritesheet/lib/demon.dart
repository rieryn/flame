...
import 'package:spritesheet/monster.dart';
...
class Demon extends Monster{
  Demon(SpriteAnimation animation, BoundingBox boundingBox, double deflationConst, Vector2 size) : super(animation, boundingBox, deflationConst, size){
 ...
 void onMount() {
    ...
    animations = {
      'demonIdle': demonIdle.createAnimation(row: 0, stepTime: 0.1, to: 6,loop:false),
      'demonAttack1': demonAttack1.createAnimation(row: 0, stepTime: 0.1, to: 8,loop:false),
      'demonAttack2': demonAttack2.createAnimation(row: 0, stepTime: 0.1, to: 11,loop:false),
      'demonCorpse': demonIdle.createAnimation(row: 0, stepTime: 0.1, to: 20,loop:false),
    };
    active();
    super.onMount();
  }
